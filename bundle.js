...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CubesList = __webpack_require__(189);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_CubesList2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CubesItem = __webpack_require__(190);

	var _CubesItem2 = _interopRequireDefault(_CubesItem);

	var _cubes = __webpack_require__(191);
	...
	var CubesList = function (_Component) {
		...
		function CubesList() {
			...
			var _this = _possibleConstructorReturn(this, (CubesList.__proto__ || Object.getPrototypeOf(CubesList)).call(this));
		...
		_createClass(CubesList, [{
			...
			key: 'render',
			value: function render() {
				var list = Object.keys(_cubes.cubes).map(function (item) {
					return _cubes.cubes[item].map(function (item2) {
						console.log(item2);
						return _react2.default.createElement(_CubesItem2.default, { name: item2.name, price: item2.price });
					});
				});
				var list2 = Object.keys(_cubes.stickers).map(function (item) {
					return _cubes.stickers[item].map(function (item2) {
						console.log(item2);
						return _react2.default.createElement(_CubesItem2.default, { name: item2.name, price: item2.price });
					});
				});
				var list3 = Object.keys(_cubes.other).map(function (item) {
					return _cubes.other[item].map(function (item2) {
						console.log(item2);
						return _react2.default.createElement(_CubesItem2.default, { name: item2.name, price: item2.price });
					});
				});
				console.log(_cubes.cubes, _cubes.stickers, _cubes.other);
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'h4',
						null,
						this.state.isCubesActive ? "Кубики" : this.state.isStickersActive ? "Наклейки" : this.state.isOthersActive ? "Остальное" : null,
						' '
					),
